...
public class CambiarContraseña extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtNombreUsuarioCambiarContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 120, 250, 40));

        btnVolverAtras.setBackground(new java.awt.Color(134, 43, 13));
        btnVolverAtras.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        ...
        jPanel1.add(btnVolverAtras, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 460, -1, 40));
        ...
        jPanel1.add(btnCambiarContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 370, -1, 60));

        txtAntiguaContraseña.setColumns(15);
        txtAntiguaContraseña.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jPanel1.add(txtAntiguaContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 200, -1, 40));

        txtNuevaContraseña.setColumns(15);
        txtNuevaContraseña.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jPanel1.add(txtNuevaContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 280, -1, 40));
